...
<title>Return Book Detail - Library Management</title>
...
<div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10">
        <div class="page-header header-with-btn">
            ...
            <a href="BookController?action=showReturnBook" class="btn btn-outline-secondary">
        ...
        <div class="row g-4">
                        ...
                        <div class="border-top pt-3">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="mb-2">
                                    ...
                                    Issued on: <strong><c:out value = "${fn:substring(bookIssued.issueDate, 0, 10)}"/></strong>
                                </li>
                                <li class="mb-2">
            ...
            <div class="col-lg-8">
                <div class="form-container">
                    ...
                    <input type="hidden" name="issueId" value="${bookIssued.issueId }">
                        <div class="row">
                            <div class="col-md-6">
